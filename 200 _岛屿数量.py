        ...
        for j in range(col):
            if not visited[i][j] and grid[i][j] != '0':
                ...
                while priorityQueue:
                    ...
                    if index[0] < row - 1 and not visited[index[0] + 1][index[1]] and grid[index[0] + 1][
                        index[1]] != '0':
                        priorityQueue.append([index[0] + 1, index[1]])
                        visited[index[0] + 1][index[1]] = True
                    if index[1] < col - 1 and not visited[index[0]][index[1] + 1] and grid[index[0]][
                        index[1] + 1] != '0':
                        priorityQueue.append([index[0], index[1] + 1])
                        visited[index[0]][index[1] + 1] = True
        ...
        for j in range(col):
            if grid[i][j] != '0':
                ...
                while priorityQueue:
                    ...
                    if index[0] < row - 1 and grid[index[0] + 1][index[1]] != '0':
                        priorityQueue.append([index[0] + 1, index[1]])
                        grid[index[0] + 1][index[1]] = '0'
                    if index[1] < col - 1 and grid[index[0]][
                        index[1] + 1] != '0':
                        priorityQueue.append([index[0], index[1] + 1])
                        grid[index[0]][index[1] + 1] = '0'
